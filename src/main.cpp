...
uint256 hashGenesisBlock("0xa3608507ab20a7da6f87e91719a1c6d423824e952328c283669aafdc7d9bfbb9");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // KaKaCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "KaKaCoin Signed Message:\n";
...
{
    // KaKaCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    // Subsidy is cut in half every 2048 blocks.
...
static const int64 nTargetTimespan = 20 * 60; // KaKaCoin: 20 minute
static const int64 nTargetSpacing = 60; // KaKaCoin: 60 seconds
static const int64 nInterval = nTargetTimespan / nTargetSpacing; // KaKaCoin: per 20blocks
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // KaKaCoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // KaKaCoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // KaKaCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xa3608507ab20a7da6f87e91719a1c6d423824e952328c283669aafdc7d9bfbb9");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "I have a dream";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 50 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("047d9663e8eefffa669de49da6cfa9ae17851b4ab5997a1f13c291d83a7b787060b8d7f93d7c5f1e58b3c78af7978def3b2b004e9d73f76c874cc7a9d9f82b5033") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1390937400;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2225744;
        ...
        assert(block.hashMerkleRoot == uint256("0x28c219806dc3d44c90c7053bf19925305ab760a71bb8865a3e64c102858e3465"));
            block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // KaKaCoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("KaKaCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("KaKaCoinMiner : ProcessBlock, block not accepted");
    }
