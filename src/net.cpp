...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "KaKaCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
  {"seed1.kakacoin.com", "seed1.kakacoin.com"},
	{"seed2.kakacoin.com", "seed2.kakacoin.com"},
	{"seed3.kakacoin.com", "seed3.kakacoin.com"},
	{"seed4.kakacoin.com", "seed4.kakacoin.com"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. KaKaCoin is probably already running."), addrBind.ToString().c_str());
        else
